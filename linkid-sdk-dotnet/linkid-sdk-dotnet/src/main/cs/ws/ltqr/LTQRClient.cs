...
namespace safe_online_sdk_dotnet
{
    public interface LTQRClient
    {
        ...
        /// <returns>Success object containing the QR in PNG format, the content of the QR code and a type 4 UUID session ID of the created long term session/
        /// This session ID will be used in the notifications to the service provider.</returns>
        ...
        /// </summary>
        /// <param name="sessionIds">optional list of long term sessions ids, if null all client sessions for all ltqr session will be returned</param>
        ...
        LTQRClientSession[] pull(String[] sessionIds, String[] clientSessionIds);

        /// <summary>
        /// Remove a set of client sessions
        /// </summary>
        /// <param name="sessionIds">﻿list of long term session Ids to remove, if list of clientSessionIds is empty, all associated ones will be removed.</param>
