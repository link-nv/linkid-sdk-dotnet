    ...
    public partial class DocDataLoggedIn : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (null != authContext && null != authContext.getAttributes())
            {
                ...
                List<LinkIDAttribute> docdataTokens = authContext.getAttributes()[DD_TOKEN];
                foreach (LinkIDAttribute docdataToken in docdataTokens)
                {
                    LinkIDCompound compound = (LinkIDCompound)docdataToken.getValue();
                    LinkIDAttribute idMember = compound.membersMap[DD_TOKEN_ID];
                    LinkIDAttribute prettyPrintMember = compound.membersMap[DD_TOKEN_PRETTY_PRINT];
                    LinkIDAttribute typeMember = compound.membersMap[DD_TOKEN_TYPE];
